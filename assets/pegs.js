...
;(function() {
	...
	function generatePegs() {
		...
		for (var i = 0; i < totalPegs; ++i) {
			...
			switch (rand) {
				case 0:
					gridContainer.append('<img class="peg" src="/lcl-stage/images/peg_green.svg" />');
					break;
				case 1:
					gridContainer.append('<img class="peg" src="/lcl-stage/images/peg_blue.svg" />');
					break;
				case 2:
					gridContainer.append('<img class="peg" src="/lcl-stage/images/peg_red.svg" />');
					break;
				case 3:
					gridContainer.append('<img class="peg" src="/lcl-stage/images/peg_yellow.svg" />');
					break;
			}
		}
